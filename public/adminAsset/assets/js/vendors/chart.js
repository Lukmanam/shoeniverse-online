...
!(function (t, e) {
                ...
                : "string" === e &&
                  ...
                  "#" === n[0] &&
                      (4 === s || 5 === s
                          ...
                          : (7 !== s && 9 !== s) || (o = { r: (r[n[1]] << 4) | r[n[2]], g: (r[n[3]] << 4) | r[n[4]], b: (r[n[5]] << 4) | r[n[6]], a: 9 === s ? (r[n[7]] << 4) | r[n[8]] : 255 })),
                  (i = o || R(t) || F(t))),
                (this._rgb = i),
                (this._valid = !!i);
        }
    ...
    function be(t, e, i, n) {
        ...
        return (c = Math.max(0, c - s.width)), (h = Math.max(0, n ? Math.floor(c / n) : h - s.height)), (c = xe(Math.min(c, a, l.maxWidth))), (h = xe(Math.min(h, r, l.maxHeight))), c && !h && (h = xe(c / 2)), { width: c, height: h };
    }
    function _e(t, e, i) {
    ...
    function Fe(t, e) {
        ...
        const o = { family: K(t.family, e.family), lineHeight: Te(K(t.lineHeight, e.lineHeight), i), size: i, style: n, weight: K(t.weight, e.weight), string: "" };
    ...
    function qe(t, e, i) {
        ...
        for (o = 0, s = t.length; o < s; ++o)
            (a = t[o]),
                (r = a.box),
                a.horizontal
                    ? ((r.left = r.fullSize ? n.left : e.left), (r.right = r.fullSize ? i.outerWidth - n.right : e.left + e.w), (r.top = c), (r.bottom = c + r.height), (r.width = r.right - r.left), (c = r.bottom))
                    : ((r.left = l), (r.right = l + r.width), (r.top = r.fullSize ? n.top : e.top), (r.bottom = r.fullSize ? i.outerHeight - n.right : e.top + e.h), (r.height = r.bottom - r.top), (l = r.right));
        (e.x = l), (e.y = c);
    }
            ...
            const o = Ie(t.options.layout.padding),
                ...
                r = (function (t) {
                    const e = (function (t) {
                        ...
                        r = Ne(e, "x"),
                        l = Ne(e, "y");
                    return { fullSize: i, leftAndTop: n.concat(s), rightAndBottom: o.concat(l).concat(a).concat(r), chartArea: We(e, "chartArea"), vertical: n.concat(o).concat(l), horizontal: s.concat(a).concat(r) };
                })(t.boxes),
                l = r.vertical,
                c = r.horizontal;
            J(t.boxes, (t) => {
    ...
    const Qe = { touchstart: "mousedown", touchmove: "mousemove", touchend: "mouseup", pointerenter: "mouseenter", pointerdown: "mousedown", pointermove: "mousemove", pointerup: "mouseup", pointerleave: "mouseout", pointerout: "mouseout" },
        Je = (t) => null === t || "" === t;
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t
                ? ((function (t, e) {
                      ...
                      if (((t.$chartjs = { initial: { height: n, width: o, style: { display: i.display, height: i.height, width: i.width } } }), (i.display = i.display || "block"), (i.boxSizing = i.boxSizing || "border-box"), Je(o))) {
                          const e = ve(t, "width");
                          void 0 !== e && (t.width = e);
                      }
                      if (Je(n))
    ...
    const ui = (t) => 0 === t || 1 === t,
        ...
        pi = {
            ...
            easeInOutExpo: (t) => (ui(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
            ...
            easeInOutElastic(t) {
                const e = 0.1125;
                return ui(t) ? t : t < 0.5 ? 0.5 * fi(2 * t, e, 0.45) : 0.5 + 0.5 * gi(2 * t - 1, e, 0.45);
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e);
    ...
    mt.describe("animation", { _fallback: !1, _indexable: !1, _scriptable: (t) => "onProgress" !== t && "onComplete" !== t && "fn" !== t }),
        mt.set("animations", { colors: { type: "color", properties: ["color", "borderColor", "backgroundColor"] }, numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius", "tension"] } }),
    ...
    class Ti {
        ...
        _dataCheck() {
            ...
            U(i)
                ...
                : t._data !== i && (t._data && (le(t._data, t), Ci(t._cachedMeta)), i && Object.isExtensible(i) && re(i, t), (t._data = i));
        }
        addElements() {
            const t = this,
                e = t._cachedMeta;
        ...
        _update(t) {
            ...
            e.configure(),
                ...
                (i._clip = (function (t) {
                    let e, i, n, o;
                    return U(t) ? ((e = t.top), (i = t.right), (n = t.bottom), (o = t.left)) : (e = i = n = o = t), { top: e, right: i, bottom: n, left: o };
                })(
                    K(
                        e.options.clip,
                        (function (t, e, i) {
            ...
            if (t >= 0 && t < n._cachedMeta.data.length) {
                ...
                (s =
                    ...
                    (e.$context = (function (t, e, i) {
                        return Object.assign(Object.create(t), { active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data" });
                    })(n.getContext(), t, e))),
                ...
                (s =
                    ...
                    (n.$context = (function (t, e) {
                        return Object.assign(Object.create(t), { active: !1, dataset: void 0, datasetIndex: e, index: e, mode: "default", type: "dataset" });
    ...
    mt.set("scale", {
        ...
        mt.describe("scale", { _fallback: !1, _scriptable: (t) => !t.startsWith("before") && !t.startsWith("after") && "callback" !== t && "parser" !== t, _indexable: (t) => "borderDash" !== t && "tickBorderDash" !== t }),
    ...
    class Yi extends Ri {
        ...
        getUserBounds() {
            ...
            return (t = q(t, Number.POSITIVE_INFINITY)), (e = q(e, Number.NEGATIVE_INFINITY)), (i = q(i, Number.POSITIVE_INFINITY)), (n = q(n, Number.NEGATIVE_INFINITY)), { min: q(t, i), max: q(e, n), minDefined: X(t), maxDefined: X(e) };
        }
        getMinMax(t) {
            const e = this;
            let i,
        ...
        update(t, e, i) {
            ...
            n.beforeUpdate(),
                ...
                n._dataLimitsCached || (n.beforeDataLimits(), n.determineDataLimits(), n.afterDataLimits(), (n._range = Ve(n, n.options.grace)), (n._dataLimitsCached = !0)),
                n.beforeBuildTicks(),
        ...
        calculateLabelRotation() {
            ...
            (a = e.offset ? t.maxWidth / n : f / (n - 1)),
                d + 6 > a &&
                    ...
                    (r = t.maxHeight - Hi(e.grid) - i.padding - ji(e.title, t.chart.options.font)),
                    (l = Math.sqrt(d * d + u * u)),
            ...
            for (x = 0; x < c; ++x) {
                ...
                (b = Ni(e, x, r)),
                    void 0 !== b &&
                        ...
                        d.push({ tx1: y, ty1: v, tx2: w, ty2: M, x1: k, y1: S, x2: P, y2: D, width: i, color: o, borderDash: a, borderDashOffset: c, tickWidth: h, tickColor: u, tickBorderDash: f, tickBorderDashOffset: g }));
            }
            ...
            for (x = 0, b = r.length; x < b; ++x) {
                ...
                a
                    ? ((v = k),
                      ...
                      d && (C *= -1))
                    : ((w = k), (C = ((1 - D) * P) / 2)),
                    m.push({ rotation: p, label: y, font: S, color: n, strokeColor: l, strokeWidth: h, textOffset: C, textAlign: M, textBaseline: O, translation: [v, w] });
            }
            return m;
        }
        ...
        _getYAxisLabelAlignment(t) {
            ...
            return (
                "left" === i
                    ? o
                        ? ((l = "left"), (c = e.right + s))
                        : ((c = e.right - a), "near" === n ? (l = "right") : "center" === n ? ((l = "center"), (c -= r / 2)) : ((l = "left"), (c = e.left)))
                    : "right" === i
                    ? o
                        ? ((l = "right"), (c = e.left + s))
                        : ((c = e.left + a), "near" === n ? (l = "left") : "center" === n ? ((l = "center"), (c += r / 2)) : ((l = "right"), (c = e.right)))
                    : (l = "right"),
                { textAlign: l, x: c }
            );
        }
        ...
        drawGrid(t) {
            ...
            const h = (t, e, i) => {
                i.width &&
                    i.color &&
                    (n.save(), (n.lineWidth = i.width), (n.strokeStyle = i.color), n.setLineDash(i.borderDash || []), (n.lineDashOffset = i.borderDashOffset), n.beginPath(), n.moveTo(t.x, t.y), n.lineTo(e.x, e.y), n.stroke(), n.restore());
            };
            if (i.display)
                for (l = 0, c = r.length; l < c; ++l) {
                    const t = r[l];
                    i.drawOnChartArea && h({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                        i.drawTicks && h({ x: t.tx1, y: t.ty1 }, { x: t.tx2, y: t.ty2 }, { color: t.tickColor, width: t.tickWidth, borderDash: t.tickBorderDash, borderDashOffset: t.tickBorderDashOffset });
                }
            if (a) {
                const t = s.lineWidth,
                    i = e._borderValue;
        ...
        drawTitle() {
            ...
            const { titleX: c, titleY: h, maxWidth: d, rotation: u } = (function (t, e, i, n) {
                ...
                let c,
                    ...
                    d,
                    u = 0;
                return t.isHorizontal() ? ((h = o(n, a, l)), (d = Bi(t, i, e)), (c = l - a)) : ((h = Bi(t, i, e)), (d = o(n, r, s)), (u = "left" === i ? -wt : wt)), { titleX: h, titleY: d, maxWidth: c, rotation: u };
            })(this, l, e, r);
            te(t, i.text, 0, 0, s, { color: i.color, maxWidth: d, rotation: u, textAlign: $i(r, e, n), textBaseline: "middle", translation: [c, h] });
        }
        draw(t) {
            const e = this;
    ...
    function Ui(t, e = [""], i = t, n, o = () => t[0]) {
        ...
        const s = { [Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: i, _fallback: n, _getTarget: o, override: (o) => Ui([o, ...t], e, i, n) };
        return new Proxy(s, {
    ...
    function Xi(t, e, i, n) {
        const o = { _cacheable: !1, _proxy: t, _context: e, _subProxy: i, _stack: new Set(), _descriptors: qi(t, n), setContext: (e) => Xi(t, e, i, n), override: (o) => Xi(t.override(o), e, i, n) };
        return new Proxy(o, {
        ...
        !(function (t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                (l = c),
                    ...
                    l &&
                        c &&
                        (At(e[h], 0, an) ? (i[h] = i[h + 1] = 0) : ((o = i[h] / e[h]), (s = i[h + 1] / e[h]), (r = Math.pow(o, 2) + Math.pow(s, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h]))));
        })(t, i, n),
            (function (t, e) {
                const i = t.length;
                let n,
    ...
    function bn(t) {
        return "angle" === t ? { between: Wt, compare: Vt, normalize: Bt } : { between: (t, e, i) => t >= Math.min(e, i) && t <= Math.max(i, e), compare: (t, e) => t - e, normalize: (t) => t };
    }
    ...
    function yn(t, e, i) {
        ...
        for (let t = h, i = h; t <= d; ++t)
            (m = e[t % a]), m.skip || ((p = c(m[n])), (b = l(p, o, s)), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(_n({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (x = p));
        ...
        return i && i.setContext && e
            ? (function (t, e, i) {
                  ...
                  for (const r of t) {
                      ...
                      for (a = s + 1; a <= r.end; a++) {
                          const h = e[a % n];
                          (l = kn(i.setContext({ type: "segment", p0: c, p1: h }))), Sn(l, t) && (o.push({ start: s, end: a - 1, loop: r.loop, style: t }), (t = l), (s = a - 1)), (c = h), (t = l);
                      }
    ...
    class Zn {
        constructor(t, e) {
            ...
            (this.id = j()),
                ...
                (Kn[n.id] = n),
                l && c ? (a.listen(n, "complete", Yn), a.listen(n, "progress", Un), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
            const {
        ...
        _resize(t, e) {
            ...
            (i.width === a.width && i.height === a.height && r === l) ||
                ((i.width = a.width), (i.height = a.height), (i._aspectRatio = i.aspectRatio), _e(i, l, !0), i.notifyPlugins("resize", { size: a }), Q(n.onResize, [i, a], i), i.attached && i._doResize() && i.render());
        }
        ensureScalesHaveIDs() {
        ...
        buildOrUpdateControllers() {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (
                    ...
                    Object.assign(i.prototype, { dataElementType: Cn.getElement(r), datasetElementType: o && Cn.getElement(o) }), (s.controller = new i(t, n)), e.push(s.controller);
                }
            }
        ...
        _drawDataset(t) {
            ...
            !1 !== e.notifyPlugins("beforeDatasetDraw", s) &&
                (Gt(i, { left: !1 === n.left ? 0 : o.left - n.left, right: !1 === n.right ? e.width : o.right + n.right, top: !1 === n.top ? 0 : o.top - n.top, bottom: !1 === n.bottom ? e.height : o.bottom + n.bottom }),
                t.controller.draw(),
                Zt(i),
                (s.cancelable = !1),
        ...
        _handleEvent(t, e) {
            ...
            return (
                ...
                (i._lastEvent = null),
                Kt(t, i.chartArea, i._minPadding) && (Q(o.onHover, [t, r, i], i), ("mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type) || Q(o.onClick, [t, r, i], i)),
                (l = !tt(r, n)),
    ...
    class ro extends Ti {
        ...
        updateElements(t, e, i, n) {
            ...
            for (let h = e; h < e + i; h++) {
                const e = o.getParsed(h),
                    ...
                    g = { horizontal: l, base: i.base, x: l ? i.head : f.center, y: l ? f.center : i.head, height: l ? f.size : void 0, width: l ? void 0 : f.size };
        ...
        _getRuler() {
            ...
            return { min: r || no(n), pixels: o, start: n._startPixel, end: n._endPixel, stackCount: t._getStackCount(), scale: n, grouped: e.grouped, ratio: r ? 1 : e.categoryPercentage * e.barPercentage };
        }
                    ...
                    l =
                        "flex" === o.barThickness
                            ...
                            : (function (t, e, i, n) {
                                  ...
                                  let s, a;
                                  return $(o) ? ((s = e.min * i.categoryPercentage), (a = i.barPercentage)) : ((s = o * n), (a = 1)), { chunk: s / n, ratio: a, start: e.pixels[t] - s / 2 };
                              })(t, e, o, n),
    ...
    (ro.id = "bar"),
        (ro.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }),
        (ro.overrides = { interaction: { mode: "index" }, scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
    class lo extends Ti {
        initialize() {
        ...
        parseObjectData(t, e, i, n) {
            const { xScale: o, yScale: s } = t,
                ...
                l = [];
            let c, h, d;
            for (c = i, h = i + n; c < h; ++c) (d = e[c]), l.push({ x: o.parse(lt(d, a), c), y: s.parse(lt(d, r), c), _custom: d && d.r && +d.r });
            return l;
        }
        getMaxOverflow() {
    ...
    (lo.id = "bubble"),
        (lo.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }),
        (lo.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } });
    class co extends Ti {
        constructor(t, e) {
    ...
    (co.id = "doughnut"),
        (co.defaults = {
            ...
            animations: { numbers: { type: "number", properties: ["circumference", "endAngle", "innerRadius", "outerRadius", "startAngle", "x", "y", "offset", "borderWidth"] } },
            cutout: "50%",
            rotation: 0,
            circumference: 360,
            radius: "100%",
                        ...
                        generateLabels(t) {
                            ...
                            return e.labels.length && e.datasets.length
                                ? e.labels.map((e, i) => {
                                      ...
                                      return { text: e, fillStyle: n.backgroundColor, strokeStyle: n.borderColor, lineWidth: n.borderWidth, hidden: !t.getDataVisibility(i), index: i };
                                  })
                                : [];
                        },
                    },
    ...
    (ho.id = "line"), (ho.defaults = { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }), (ho.overrides = { scales: { _index_: { type: "category" }, _value_: { type: "linear" } } });
    class uo extends Ti {
        constructor(t, e) {
    ...
    (go.id = "radar"),
        (go.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
        (go.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
    class po extends ho {}
    (po.id = "scatter"),
        (po.defaults = { showLine: !1, fill: !1 }),
        (po.overrides = { interaction: { mode: "point" }, plugins: { tooltip: { callbacks: { title: () => "", label: (t) => "(" + t.label + ", " + t.formattedValue + ")" } } }, scales: { x: { type: "linear" }, y: { type: "linear" } } });
    var mo = Object.freeze({ __proto__: null, BarController: ro, BubbleController: lo, DoughnutController: co, LineController: ho, PolarAreaController: uo, PieController: fo, RadarController: go, ScatterController: po });
    function xo(t, e) {
    ...
    function bo(t, e, i, n) {
        ...
        return { outerStart: r(o.outerStart), outerEnd: r(o.outerEnd), innerStart: Nt(o.innerStart, 0, a), innerEnd: Nt(o.innerEnd, 0, a) };
    }
    function _o(t, e, i, n) {
    ...
    function yo(t, e) {
        const { x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a } = e,
            ...
            l = e.innerRadius + a,
            { outerStart: c, outerEnd: h, innerStart: d, innerEnd: u } = bo(e, l, r, s - o),
            f = r - c,
            g = r - h,
            p = o + c / f,
            m = s - h / g,
    ...
    function vo(t, e) {
        ...
        i.borderWidth &&
            (n ? ((t.lineWidth = 2 * i.borderWidth), (t.lineJoin = "round")) : ((t.lineWidth = i.borderWidth), (t.lineJoin = "bevel")),
            e.fullCircles &&
                (function (t, e, i) {
                    const { x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r } = e,
                        ...
                        c = e.innerRadius + r;
                    let h;
                    for (i && ((e.endAngle = e.startAngle + bt), xo(t, e), (e.endAngle = a), e.endAngle === e.startAngle && ((e.endAngle += bt), e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + bt, s, !0), h = 0; h < e.fullCircles; ++h)
                        t.stroke();
    ...
    class wo extends Ri {
        ...
        draw(t) {
            const e = this,
                i = e.options,
                n = i.offset || 0;
            if (((e.pixelMargin = "inner" === i.borderAlign ? 0.33 : 0), (e.fullCircles = Math.floor(e.circumference / bt)), !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0))) {
    ...
    (wo.id = "arc"), (wo.defaults = { borderAlign: "center", borderColor: "#fff", borderRadius: 0, borderWidth: 2, offset: 0, angle: void 0 }), (wo.defaultRoutes = { backgroundColor: "backgroundColor" });
        ...
        Oo && 1 === e.segments.length
            ...
            : (function (t, e, i, n) {
                  const { segments: o, options: s } = e,
                      a = Co(e);
                  for (const r of o) Mo(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke();
              })(t, e, i, n);
    }
    class To extends Ri {
        constructor(t) {
    ...
    class Lo extends Ri {
        ...
        draw(t) {
            const e = this,
                i = e.options;
            e.skip || i.radius < 0.1 || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), qt(t, i, e.x, e.y));
        }
        getRange() {
    ...
    function Eo(t, e) {
        ...
        let r, l, c, h, d;
        return (
            t.horizontal ? ((d = a / 2), (r = Math.min(i, o)), (l = Math.max(i, o)), (c = n - d), (h = n + d)) : ((d = s / 2), (r = i - d), (l = i + d), (c = Math.min(n, o)), (h = Math.max(n, o))), { left: r, top: c, right: l, bottom: h }
        );
    }
    function Io(t) {
        ...
        const e = Eo(t),
            ...
            o = (function (t, e, i) {
                const n = t.options.borderWidth,
                    o = Io(t),
                    s = Le(n);
                return { t: Vo(o.top, s.top, 0, i), r: Vo(o.right, s.right, 0, e), b: Vo(o.bottom, s.bottom, 0, i), l: Vo(o.left, s.left, 0, e) };
            })(t, i / 2, n / 2),
            s = (function (t, e, i) {
                const n = Ee(t.options.borderRadius),
                    o = Math.min(e, i),
                    s = Io(t);
                return { topLeft: Vo(s.top || s.left, n.topLeft, 0, o), topRight: Vo(s.top || s.right, n.topRight, 0, o), bottomLeft: Vo(s.bottom || s.left, n.bottomLeft, 0, o), bottomRight: Vo(s.bottom || s.right, n.bottomRight, 0, o) };
            })(t, i / 2, n / 2);
        return {
    ...
    (Lo.id = "point"),
        (Lo.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }),
    ...
    (Ho.id = "bar"), (Ho.defaults = { borderSkipped: "start", borderWidth: 0, borderRadius: 0, pointStyle: void 0 }), (Ho.defaultRoutes = { backgroundColor: "backgroundColor", borderColor: "borderColor" });
            ...
            t.data.datasets.forEach((e, o) => {
                ...
                let h,
                    { start: d, count: u } = (function (t, e) {
                        ...
                        return l && (o = Nt(ne(e, s.axis, a).lo, 0, i - 1)), (n = c ? Nt(ne(e, s.axis, r).hi + 1, o, i) - o : i - o), { start: o, count: n };
                    })(r, l);
                if (u <= 4 * n) $o(e);
                else {
                    switch (
    ...
    function Ko(t) {
        return (t.scale || {}).getPointPositionForValue
            ? (function (t) {
                  ...
                  let l, c, h;
                  if (((h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular)) return (c = e.getPointPositionForValue(0, a)), new qo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) });
            ...
            : (function (t) {
                  ...
                  let n,
                      o = null;
                  return (
                      "start" === i ? (o = e.bottom) : "end" === i ? (o = e.top) : U(i) ? (o = e.getPixelForValue(i.value)) : e.getBasePixel && (o = e.getBasePixel()),
                ...
                for (const t of n) {
                    ...
                    for (const e of r) {
                        const r = ns(i, s[e.start], s[e.end], e.loop),
                            l = yn(t, o, r);
                        for (const t of l) a.push({ source: t, target: e, start: { [i]: os(n, r, "start", Math.max) }, end: { [i]: os(n, r, "end", Math.min) } });
                    }
                }
                return a;
            })(i, n, o);
    ...
    function ls(t, e, i) {
        ...
        n &&
            ...
            (function (t, e) {
                ...
                t.save(),
                    "x" === l && s !== o && (is(t, n, a.top), rs(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), is(t, n, a.bottom)),
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                (s = t.getDatasetMeta(a)),
                    (r = s.dataset),
                    (l = null),
                    r && r.options && r instanceof To && (l = { visible: t.isDatasetVisible(a), index: a, fill: Xo(r, a, n), chart: t, axis: s.controller.options.indexAxis, scale: s.vScale, line: r }),
                    (s.$filler = l),
                    o.push(l);
    ...
    class ds extends Ri {
        ...
        _draw() {
            ...
            (m = y ? { x: o(r, t.left + f, t.right - n[0]), y: t.top + f + v, line: 0 } : { x: t.left + f, y: o(r, t.top + v + f, t.bottom - i[0].height), line: 0 }), mn(t.ctx, e.textDirection);
            const w = _ + f;
            t.legendItems.forEach((e, M) => {
                ...
                h.setWidth(t.width),
                    y
                        ? M > 0 && D + P + f > t.right && ((C = m.y += w), m.line++, (D = m.x = o(r, t.left + f, t.right - n[m.line])))
                        : M > 0 && C + w > t.bottom && ((D = m.x = D + i[m.line].width + f), m.line++, (C = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
                !(function (t, e, i) {
                    ...
                    if (
                        ...
                        const o = e + Math.max((g - b) / 2, 0),
                            s = h.leftForLtr(t, x),
                            r = Ee(i.borderRadius);
                        a.beginPath(), Object.values(r).some((t) => 0 !== t) ? ee(a, { x: s, y: o, w: x, h: b, radius: r }) : a.rect(s, o, x, b), a.fill(), 0 !== n && a.stroke();
                    }
                    a.restore();
                })(h.x(D), C, e),
                    (D = s(S, D + x + p, t.right)),
        ...
        _getLegendItemAt(t, e) {
            ...
            if (t >= i.left && t <= i.right && e >= i.top && e <= i.bottom)
                for (s = i.legendHitBoxes, n = 0; n < s.length; ++n) if (((o = s[n]), t >= o.left && t <= o.left + o.width && e >= o.top && e <= o.top + o.height)) return i.legendItems[n];
            return null;
        }
        handleEvent(t) {
            const e = this,
    ...
    class fs extends Ri {
        ...
        _drawArgs(t) {
            ...
            let l,
                ...
                d = 0;
            return (
                this.isHorizontal() ? ((c = o(r, i, s)), (h = e + t), (l = s - i)) : ("left" === a.position ? ((c = i + t), (h = o(r, n, e)), (d = -0.5 * xt)) : ((c = s - t), (h = o(r, e, n)), (d = 0.5 * xt)), (l = n - e)),
    ...
    function bs(t, e) {
        ...
        return { chart: t, label: a, parsed: s.getParsed(o), raw: t.data.datasets[n].data[o], formattedValue: r, dataset: s.getDataset(), dataIndex: o, datasetIndex: n, element: i };
    }
    function _s(t, e) {
    ...
    function ws(t, e, i, n) {
        ...
        return "center" === l ? ("left" === r ? (d += c) : "right" === r && (d -= c)) : "left" === r ? (d -= h) : "right" === r && (d += h), { x: Nt(d, 0, n.width - e.width), y: Nt(u, 0, n.height - e.height) };
    }
    function Ms(t, e, i) {
    ...
    class Ps extends Ri {
        ...
        getCaretPosition(t, e, i) {
            ...
            return (
                "center" === o
                    ? ((p = l + h / 2), "left" === n ? ((d = r), (u = d - a), (g = p + a), (m = p - a)) : ((d = r + c), (u = d + a), (g = p - a), (m = p + a)), (f = d))
                    : ((u = "left" === n ? r + s + a : "right" === n ? r + c - s - a : this.caretX), "top" === o ? ((g = l), (p = g - a), (d = u - a), (f = u + a)) : ((g = l + h), (p = g + a), (d = u + a), (f = u - a)), (m = g)),
        ...
        drawTitle(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = Ms(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l)
            ...
            if (o.usePointStyle) {
                ...
                Object.values(s).some((t) => 0 !== t)
                    ? (t.beginPath(),
                      ...
                      t.fill())
                    : ((t.fillStyle = o.multiKeyBackground), t.fillRect(e, g, c, l), t.strokeRect(e, g, c, l), (t.fillStyle = a.backgroundColor), t.fillRect(i, g + 1, c - 2, l - 2));
            }
        ...
        drawBody(t, e, i) {
            ...
            let m, x, b, _, y, v, w;
            for (
                e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = Ms(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && "right" !== p ? ("center" === a ? c / 2 + 1 : c + 2) : 0, _ = 0, v = o.length;
                _ < v;
                ++_
            ) {
        ...
        drawFooter(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = Ms(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r)
    ...
    class Ts extends Yi {
        ...
        buildTicks() {
            ...
            const o = (function (t, e) {
                ...
                (_ = Math.ceil(u / y) - Math.floor(d / y)),
                    ...
                    f && g && n && Tt((s - o) / n, y / 1e3)
                        ...
                        : ((_ = (b - x) / y), (_ = At(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_))),
            ...
            })({ maxTicks: n, min: e.min, max: e.max, precision: i.precision, step: i.stepSize, count: i.count }, t._range || t);
        ...
        buildTicks() {
            const t = this,
                ...
                i = (function (t, e) {
                    ...
                    do {
                        o.push({ value: s, major: Ls(s) }), ++r, 10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)), (s = Math.round(r * Math.pow(10, a) * l) / l);
                    } while (a < i || (a === i && r < n));
                    const c = q(t.max, s);
                        ...
                        if (0 !== i) {
                            ...
                            !(function (t, e, i, n) {
                                ...
                                (!s && !n) ||
                                    ...
                                    !r ||
                                    i < 0 ||
                                    (o.save(), (o.strokeStyle = a), (o.lineWidth = r), o.setLineDash(e.borderDash), (o.lineDashOffset = e.borderDashOffset), o.beginPath(), Bs(t, i, s, n), o.closePath(), o.stroke(), o.restore());
                            })(t, n, r, s);
                        }
                    }),
                n.display)
    ...
    (Ns.id = "radialLinear"),
        (Ns.defaults = {
            ...
            grid: { circular: !1 },
            startAngle: 0,
            ticks: { showLabelBackdrop: !0, backdropColor: "rgba(255,255,255,0.75)", backdropPadding: 2, callback: Fi.formatters.numeric },
            pointLabels: { backdropColor: void 0, backdropPadding: 2, display: !0, font: { size: 10 }, callback: (t) => t, padding: 5 },
        }),
        (Ns.defaultRoutes = { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
    ...
    class Ks extends Yi {
        constructor(t) {
            super(t), (this._cache = { data: [], labels: [], all: [] }), (this._unit = "day"), (this._majorUnit = void 0), (this._offsets = {}), (this._normalized = !1);
        }
        init(t, e) {
    ...
    (Ks.id = "time"), (Ks.defaults = { bounds: "data", adapters: {}, time: { parser: !1, unit: !1, round: !1, isoWeekday: !1, minUnit: "millisecond", displayFormats: {} }, ticks: { source: "auto", major: { enabled: !1 } } });
    class Zs extends Ks {
        constructor(t) {
    ...
    var Qs = Object.freeze({ __proto__: null, CategoryScale: As, LinearScale: Rs, LogarithmicScale: Es, RadialLinearScale: Ns, TimeScale: Ks, TimeSeriesScale: Zs });
    return (
